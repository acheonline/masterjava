...
public abstract class UserDao implements AbstractDao {
    ...
    @SqlUpdate("INSERT INTO users (id, full_name, email, flag, city_id) VALUES (:id, :fullName, :email, :city.id, CAST(:flag AS USER_FLAG)) ")
    ...
    @SqlBatch("INSERT INTO users (id, full_name, email, flag, city_id) VALUES (:id, :fullName, :email, :city.id, CAST(:flag AS USER_FLAG))" +
